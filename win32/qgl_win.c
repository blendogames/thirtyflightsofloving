...
// Knightmare added
BOOL ( WINAPI * qwglGetDeviceGammaRamp3DFX)( HDC hDC, LPVOID ramp ); 
BOOL ( WINAPI * qwglSetDeviceGammaRamp3DFX)( HDC hDC, LPVOID ramp );
...
qboolean QGL_Init( const char *dllname )
{
	...
	// Knightmare added
	qwglGetDeviceGammaRamp3DFX	= 0;
	qwglSetDeviceGammaRamp3DFX	= 0;
