...
#define	MAXPRINTMSG	16384 //was 8192
void VID_Printf (int print_level, char *fmt, ...)
{
	...
	//_vsnprintf(msg, MAXPRINTMSG, fmt, argptr); // Knightmare - fix for nVidia 191.xx crash (bd)


	
	strncpy(msg, fmt, 64); //BC 9-5-2016 Uhhhhh maybe fixed the nvidia crash?
