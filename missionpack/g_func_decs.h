...
extern void SP_monster_sentien_precache ( edict_t * self ) ;
extern void monster_sentien_soundcache ( edict_t * self ) ;
...
extern void SP_monster_hound_precache ( edict_t * self ) ;
extern void monster_hound_soundcache ( edict_t * self ) ;
...
extern void SP_monster_handler_precache ( edict_t * self ) ;
extern void monster_handler_soundcache ( edict_t * self ) ;
...
extern void SP_monster_zboss_precache ( edict_t * self ) ;
extern void monster_zboss_soundcache ( edict_t * self ) ;
...
extern unsigned int Com_ParseRGBAFieldPacked ( const char * s ) ;
extern qboolean Com_ParseRGBAField ( const char * s , color_t outColor ) ;
extern unsigned int Com_ParseColorStringPacked ( const char * s ) ;
...
extern void P_ProjectSource2 ( edict_t * client_ent , vec3_t point , vec3_t distance , vec3_t forward , vec3_t right , vec3_t up , vec3_t result ) ;
extern void P_ProjectSource ( edict_t * client_ent , vec3_t point , vec3_t distance , vec3_t forward , vec3_t right , vec3_t result ) ;
...
extern void monster_widow2_soundcache ( edict_t * self ) ;
...
extern void monster_widow_soundcache ( edict_t * self ) ;
...
extern void monster_vulture_soundcache ( edict_t * self ) ;
...
extern void monster_tank_soundcache ( edict_t * self ) ;
...
extern void monster_supertank_soundcache ( edict_t * self ) ;
...
extern void monster_stalker_soundcache ( edict_t * self ) ;
...
extern void monster_soldier_q25_soundcache ( edict_t * self ) ;
...
extern void monster_soldier_h_soundcache ( edict_t * self ) ;
...
extern void monster_soldier_x_soundcache ( edict_t * self ) ;
...
extern void monster_q1_zombie_soundcache ( edict_t * self ) ;
...
extern void monster_q1_tarbaby_soundcache ( edict_t * self ) ;
...
extern void monster_q1_shambler_soundcache ( edict_t * self ) ;
...
extern void shambler_show_lightning ( edict_t * self ) ;
extern void shambler_lightning_animate ( edict_t * bolt ) ;
...
extern void monster_q1_shalrath_soundcache ( edict_t * self ) ;
...
extern void monster_q1_scrag_soundcache ( edict_t * self ) ;
...
extern void monster_q1_rotfish_soundcache ( edict_t * self ) ;
...
extern void monster_q1_ogre_soundcache ( edict_t * self ) ;
...
extern void monster_q1_knight_soundcache ( edict_t * self ) ;
...
extern void monster_q1_hknight_soundcache ( edict_t * self ) ;
...
extern void monster_q1_grunt_soundcache ( edict_t * self ) ;
...
extern void monster_q1_freddie_soundcache ( edict_t * self ) ;
...
extern void monster_q1_fiend_soundcache ( edict_t * self ) ;
...
extern void monster_q1_enforcer_soundcache ( edict_t * self ) ;
...
extern void monster_q1_dog_soundcache ( edict_t * self ) ;
...
extern void SP_monster_q1_chthon ( edict_t * self ) ;
extern void monster_q1_chthon_soundcache ( edict_t * self ) ;
extern void chthon_awake ( edict_t * self , edict_t * other , edict_t * activator ) ;
extern qboolean chthon_checkattack ( edict_t * self ) ;
extern void chthon_check_attack ( edict_t * self ) ;
extern void chthon_sight ( edict_t * self , edict_t * other ) ;
...
extern void chthon_pain ( edict_t * self , edict_t * other , float kick , int damage ) ;
extern void chthon_run ( edict_t * self ) ;
extern void chthon_walk ( edict_t * self ) ;
extern void chthon_rise ( edict_t * self ) ;
extern void chthon_framestart ( edict_t * self ) ;
extern void chthon_framemid ( edict_t * self ) ;
extern void chthon_frameend ( edict_t * self ) ;
extern void chthon_stand ( edict_t * self ) ;
extern void chthon_sight_sound2 ( edict_t * self ) ;
extern void chthon_sight_sound ( edict_t * self ) ;
extern void chthon_sink ( edict_t * self ) ;
extern void chthon_rise_sound ( edict_t * self ) ;
extern void chthon_lava_splash ( edict_t * self ) ;
extern void SP_monster_parasite ( edict_t * self ) ;
extern void monster_parasite_soundcache ( edict_t * self ) ;
...
extern void monster_mutant_soundcache ( edict_t * self ) ;
...
extern void monster_medic_soundcache ( edict_t * self ) ;
...
extern void misc_insane_soundcache ( edict_t * self ) ;
...
extern void monster_infantry_soundcache ( edict_t * self ) ;
...
extern void monster_hover_soundcache ( edict_t * self ) ;
...
extern void monster_gunner_soundcache ( edict_t * self ) ;
...
extern void monster_gladiator_soundcache ( edict_t * self ) ;
...
extern void monster_gladb_soundcache ( edict_t * self ) ;
...
extern void monster_gekk_soundcache ( edict_t * self ) ;
...
extern void monster_flyer_soundcache ( edict_t * self ) ;
...
extern void monster_floater_soundcache ( edict_t * self ) ;
...
extern void monster_flipper_soundcache ( edict_t * self ) ;
...
extern void monster_fixbot_soundcache ( edict_t * self ) ;
...
extern void monster_dog_soundcache ( edict_t * self ) ;
...
extern void monster_chick_soundcache ( edict_t * self ) ;
...
extern void monster_carrier_soundcache ( edict_t * self ) ;
...
extern void monster_brain_beta_soundcache ( edict_t * self ) ;
...
extern void monster_brain_soundcache ( edict_t * self ) ;
...
extern void monster_boss5_soundcache ( edict_t * self ) ;
...
extern void MakronPrecache ( edict_t * self ) ;
extern void monster_makron_soundcache ( edict_t * self ) ;
...
extern void monster_jorg_soundcache ( edict_t * self ) ;
...
extern void monster_boss2_soundcache ( edict_t * self ) ;
...
extern void monster_berserk_soundcache ( edict_t * self ) ;
...
extern void SP_q1_zombiegib ( edict_t * gib ) ;
extern void q1_zombiegib_delayed_start ( edict_t * gib ) ;
extern void q1_zombiegib_precache ( void ) ;
...
extern void SP_q1_acidspit ( edict_t * acidbolt ) ;
extern void q1_acidspit_delayed_start ( edict_t * acidbolt ) ;
...
extern void SP_q1_lavaball ( edict_t * lavaball ) ;
extern void q1_lavaball_delayed_start ( edict_t * lavaball ) ;
...
extern void SP_q1_firepod ( edict_t * pod ) ;
extern void q1_firepod_delayed_start ( edict_t * pod ) ;
...
extern void SP_q1_grenade ( edict_t * grenade ) ;
extern void q1_grenade_delayed_start ( edict_t * grenade ) ;
...
extern void SP_q1_flame ( edict_t * bolt ) ;
extern void q1_flame_delayed_start ( edict_t * bolt ) ;
...
extern void SP_q1_laser ( edict_t * laser ) ;
extern void q1_laser_delayed_start ( edict_t * laser ) ;
...
extern void SP_q1_nail ( edict_t * nail ) ;
extern void q1_nail_delayed_start ( edict_t * nail ) ;
...
extern qboolean IsQ1Chthon ( edict_t * self ) ;
...
extern qboolean IsMakronNoJumpHackMap ( void ) ;
extern qboolean IsMakronNoBFGHackMap ( void ) ;
...
extern qboolean AllPlayersLinkcountCmp ( int cmp_linkcount ) ;
extern qboolean AllPlayersSpawned ( void ) ;
extern qboolean AnyPlayerSpawned ( void ) ;
...
extern void G_SoundcacheEntities ( void ) ;
...
extern void SP_target_q1_bolt ( edict_t * self ) ;
extern void use_target_bolt ( edict_t * self , edict_t * other , edict_t * activator ) ;
extern void think_targetbolt ( edict_t * self ) ;
extern void target_fire_lightning ( edict_t * self , vec3_t start , vec3_t dir , int damage ) ;
...
extern void SP_misc_flare ( edict_t * self ) ;
...
extern void fd_secret_begin ( edict_t * self ) ;
...
extern void door_secret_begin ( edict_t * self ) ;
...
extern void Cmd_PrefWeap_f ( edict_t * ent ) ;
extern void Cmd_CycleWeap_f ( edict_t * ent ) ;
